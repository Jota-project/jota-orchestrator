...
async def chat_endpoint(
    ...
    try:
        ...
        # 5. Save User Message
        await memory_manager.save_message(conversation_id, request.user_id, "user", request.text)
...
async def websocket_endpoint(websocket: WebSocket, user_id: str):
    ...
    try:
        ...
        while True:
            ...
            # 5. Save User Message
            await memory_manager.save_message(conversation_id, user_id, "user", data)
